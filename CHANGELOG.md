...
- Added the `dev.effect.intellij` plugin scaffold on the `2025.3.x` baseline.
...
- Documented the remaining deferred areas: live debugger snapshots, optional JCEF tracer work, and local Mermaid preview transport.
