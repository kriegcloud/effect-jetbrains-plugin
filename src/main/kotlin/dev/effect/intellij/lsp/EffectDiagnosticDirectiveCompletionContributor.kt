...
class EffectDiagnosticDirectiveCompletionContributor : CompletionContributor() {
    ...
    companion object {
        ...
        val RULE_NAMES: List<String> = listOf(
            ...
            "overriddenSchemaConstructor", "preferSchemaOverJson", "preferSchemaTypeProperty", "processEnv",
            "processEnvInEffect",
            "redundantMapError", "redundantOrDie", "redundantSchemaTagIdentifier", "returnEffectInGen",
            "runEffectInsideEffect", "schemaNumber", "schemaOpaqueInstanceMember", "schemaStructWithTag",
            "schemaSyncInEffect",
