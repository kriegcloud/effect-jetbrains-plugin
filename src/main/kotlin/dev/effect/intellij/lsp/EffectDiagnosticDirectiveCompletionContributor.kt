...
class EffectDiagnosticDirectiveCompletionContributor : CompletionContributor() {
    ...
    companion object {
        ...
        val RULE_NAMES: List<String> = listOf(
            "abortControllerInEffect", "anyUnknownInErrorContext", "asyncFunction", "catchAllToMapError",
            "catchChainToFirstSuccessOf", "catchTagToCatchReason", "catchToIgnore",
            ...
            "effectSucceedWithVoid", "extendsNativeError", "flatMapToMap", "floatingEffect",
            "floatingEffectInVitest", "genericEffectServices",
            ...
            "missingEffectServiceDependency", "missingLayerContext", "missingPipeableSignature",
            ...
            "schemaStructWithTag", "schemaSyncInEffect",
            "schemaUnionOfLiterals", "scopeInLayerEffect", "serviceNotAsClass", "strictBooleanExpressions",
            "strictEffectProvide", "syncToSucceed", "tryCatchInEffectGen", "unknownInEffectCatch",
