...
class EffectDiagnosticDirectiveCompletionContributor : CompletionContributor() {
    ...
    companion object {
        ...
        val RULE_NAMES: List<String> = listOf(
            "abortControllerInEffect", "acquireReleaseDisposable", "allOfMapToForEach",
            "anyUnknownInErrorContext", "asyncFunction", "catchAllTagDispatchToCatchTag", "catchAllToMapError",
            "catchChainToFirstSuccessOf", "catchConditionalRefailToCatchIf", "catchDieToOrDie",
            "catchTagToCatchReason", "catchToIgnore", "catchToOrElseSucceed", "catchUnfailableEffect",
            "classSelfMismatch", "cryptoRandomUUID", "cryptoRandomUUIDInEffect", "deterministicKeys",
            "duplicatePackage", "effectDoNotation", "effectFnIife", "effectFnImplicitAny", "effectFnOpportunity",
            "effectGenUsesAdapter", "effectInFailure", "effectInVoidSuccess", "effectMapFlatten", "effectMapVoid",
            "effectSucceedWithVoid", "extendsNativeError", "flatMapConditionalToFilterOrFail", "flatMapToMap",
            "floatingEffect", "floatingEffectInVitest", "genericEffectServices", "globalConsole",
            "globalConsoleInEffect", "globalDate", "globalDateInEffect", "globalErrorInEffectCatch",
            "globalErrorInEffectFailure", "globalFetch", "globalFetchInEffect", "globalRandom",
            "globalRandomInEffect", "globalTimers", "globalTimersInEffect", "instanceOfSchema",
            "layerMergeAllWithDependencies", "lazyEffect", "lazyPromiseInEffectSync", "leakingRequirements",
            "mapSomeToAsSome", "matchEffectToMapBoth", "matchEffectToMatch", "missedPipeableOpportunity",
            "missingEffectContext", "missingEffectError", "missingEffectServiceDependency", "missingLayerContext",
            "missingPipeableSignature", "missingReturnYieldStar", "missingStarInYieldEffectGen",
            "multipleCatchTag", "multipleEffectProvide", "nestedEffectGenYield", "newPromise", "newSchemaClass",
            "nodeBuiltinImport", "nonObjectEffectServiceType", "obsoleteMatchImport", "obsoleteSchemaImport",
            "optionMatchToFromOption", "outdatedApi", "overriddenSchemaConstructor", "preferSchemaOverJson",
            "preferSchemaTypeProperty", "preferSucceedSomeOrNone", "preferTypedSchemaDecoder",
            "preferUnsafeConstructor", "processEnv", "processEnvInEffect", "promiseInEffectSuccess",
            "provideLayerSucceedToProvideService", "raceFirstWithSleepToTimeout", "redundantMapError",
            "redundantOrDie", "redundantSchemaTagIdentifier", "returnEffectInGen", "runEffectInsideEffect",
            "runOfExitToRunExit", "schemaLiteralNonFinite", "schemaNumber", "schemaOpaqueInstanceMember",
            "schemaStructWithTag", "schemaSync", "schemaSyncInEffect", "schemaUnionOfLiterals",
            "scopeInLayerEffect", "serviceNotAsClass", "strictBooleanExpressions", "strictEffectProvide",
            "syncToSucceed", "timeoutCatchTagToTimeoutOrElse", "tryCatchInEffectGen", "unknownInEffectCatch",
