...
class EffectDiagnosticDirectiveCompletionContributor : CompletionContributor() {
    ...
    companion object {
        ...
        val RULE_NAMES: List<String> = listOf(
            ...
            "effectSucceedWithVoid", "extendsNativeError", "floatingEffect", "genericEffectServices",
            ...
            "schemaUnionOfLiterals", "scopeInLayerEffect", "serviceNotAsClass", "setInterval", "setTimeout",
            "strictBooleanExpressions", "strictEffectProvide", "tryCatchInEffectGen", "unknownInEffectCatch",
